...
public class MaterialComparation implements Serializable {
	...
	//	materialCooking: 	each material of the food
	//	food:	current food
	//	listMaterial: 	list all material
	//	compare material with data in list material
	//	=>	insert food material into database
	//	=>	return food (with update in energy)
    public static Food compareMaterial(List<Material> listMaterial, String materialCooking, Food food) throws MalformedURLException, IOException, ClassNotFoundException, SQLException, Exception {
        ...
        for (Material material : listMaterial) {
            try {
                ...
                urlConnection.addRequestProperty(CONSTANTS.STRING_SIMILARITY_ADD_REQUEST_PROPERTY_AGENT, CONSTANTS.STRING_SIMILARITY_ADD_REQUEST_PROPERTY_BROWSER);
